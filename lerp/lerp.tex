...
\begin{align*}
  ...
  %% &= 4\left(-3w_{n-1}^{u-2}h_{n-1}^{v+1}+w_{n-1}^{u-1}h_{n-1}^vc_{n-1}+2w_{n-1}^{u-1}h_{n-1}^vc_n\right) \\
  %% \frac{\partial K}{\partial c_i}
  ...
  %% +w_{i-1}^{u-1}h_{i-1}^vc_{i-1}
  %% +\left(2w_{i-1}^{u-1}h_{i-1}^v+2w_i^{u-1}h_i^v\right)c_i
  %% \right)
\end{align*}
\begin{align*}
  4\left(-\frac{3w_1^{u-2}}{h_1^{v-1}}+\frac{2w_1^{u-1}}{h_1^v}c_1+\frac{w_1^{u-1}}{h_1^v}c_2\right)
