...
A CNF statement is a formula consisting of expressions joined by $\land$,
where each expression consists of terms joined by $\lor$,
...
is not, since the sub-expressions cannot be negated.
