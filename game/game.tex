...
Crush an object between two others of higher priority:
detectable by overflow of denominator of current time/position \\
Have an object perfectly sandwiched between two bouncy walls:
detectable by returning perfectly(?) to previous state \\
